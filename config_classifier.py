...
def get_config_pars_classifier(stage):
    ...
    if stage == "trainval":
        ...
        parser_.add_argument("--train_data_dir", type=str, default='covid_data/cncb/train',
                             help="Path to the training data. Must contain images and binary masks")
        parser_.add_argument("--val_data_dir", type=str, default='covid_data/cncb/val',
        ...
        parser_.add_argument("--test_data_dir", type=str, default='covid_data/cncb/test',
